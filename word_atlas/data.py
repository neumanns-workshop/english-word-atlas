...
def load_dataset(data_dir: Optional[Union[str, Path]] = None) -> Dict[str, Dict[str, Any]]:
    ...
    for word in word_data:
        if word in word_to_idx:
            word_data[word]['EMBEDDINGS_ALL_MINILM_L6_V2'] = embeddings[word_to_idx[word]].tolist()
...
def get_available_attributes(data_dir: Optional[Union[str, Path]] = None) -> Dict[str, int]:
