...
from tests.test_wordlist import mock_atlas, empty_builder, test_wordlist, populated_builder
...
class TestBranchCoverage:
    ...
    def test_add_by_custom_filter_no_matches(self, empty_builder):
        ...
        result = empty_builder.add_by_custom_filter(never_match, "Never matches anything")
        assert result == 0
        assert empty_builder.get_size() == 0
    ...
    def test_search_invalid_regex(self, mock_atlas):
        ...
        results = mock_atlas.search("[cat")  # Invalid regex, should fall back to substring
